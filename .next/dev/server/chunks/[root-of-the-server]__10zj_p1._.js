...
"[project]/src/app/api/tracking-config/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function writeCredentials(data) {
    try {
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].writeFileSync(CREDENTIALS_PATH, JSON.stringify(data, null, 2), "utf-8");
        return true;
    } catch (err) {
...
async function POST(req) {
    try {
        ...
        if (success) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$9_$40$babel$2b$core$40$7$2e$2_1142e53145b8313024f0c22f27c8b564$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
                message: "Credentials updated successfully on server"
            });
        } else {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$9_$40$babel$2b$core$40$7$2e$2_1142e53145b8313024f0c22f27c8b564$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: "Failed to save credentials to file"
            }, {
                status: 500
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__10zj_p1._.js.map